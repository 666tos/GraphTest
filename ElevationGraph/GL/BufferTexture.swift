...
open class BufferTexture {
    ...
    open func load(_ data: [CGPoint]) -> Bool {
        ...
        tacx_glTexImage2D(target: GL_TEXTURE_2D, level: 0, internalformat: GL_RG32F, width: GLsizei(data.count), height: 1, border: 0, format: GL_RG, type: GL_FLOAT, pixels: floatData)
